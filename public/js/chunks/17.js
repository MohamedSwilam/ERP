  ...
  methods: {
    browseCustomerTypes: function browseCustomerTypes() {
      ...
      this.$store.dispatch('seed/browseCustomerTypes', '').then(function (response) {
        _this.customers.customer_types = [{
          text: 'All',
          value: ''
    ...
    browseCustomers: function browseCustomers() {
      ...
      this.$store.dispatch('customer/browse', "?paginate=".concat(this.customers.recordsPerPage, "&page=").concat(page, "&filter[search]=").concat(this.customers.search, "&filter[customer_type]=").concat(this.customers.customer_type, "&filter[next_follow_up_from]=").concat(this.customers.from, "&filter[next_follow_up_to]=").concat(this.customers.to)).then(function (response) {
        _this2.customers.data = response.data.data;
        _this2.customers.meta = response.data.meta.pagination;
        _this2.customers.isLoading = false;
      })["catch"](function (error) {
        console.error(error);
        _this2.customers.isLoading = false;
      });
    ...
    deleteCustomer: function deleteCustomer(data) {
      ...
      this.$bvModal.msgBoxConfirm('You will not be able to retrieve this again!', {
        ...
        if (confirmed) {
          _this3.$store.dispatch('customer/delete', data.item.id).then(function (response) {
            _this3.customers.data = _this3.customers.data.filter(function (customer) {
    ...
    exportCsv: function exportCsv() {
      ...
      csvExporter.generateCsv(this.customers.data.map(function (customer) {
        return {
          Id: "#TKB".concat(customer.id),
          Name: customer.name,
                                  ...
                                  _c("b-select", {
                                    attrs: {
                                      dir: _vm.$store.state.appConfig.isRTL
                                        ? "rtl"
                                        : "ltr",
                                      options: _vm.customers.customer_types,
                                      label: "text"
                                    },
                                    on: {
                                      change: function($event) {
                                    ...
                                    model: {
                                      value: _vm.customers.customer_type,
                                      callback: function($$v) {
                                        _vm.$set(
                                          _vm.customers,
                                          "customer_type",
                                      ...
                                      expression: "customers.customer_type"
                                    }
                                  })
                                ],
                                1
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _c("b-form-input", {
                                    ...
                                    model: {
                                      value: _vm.customers.from,
                                      callback: function($$v) {
                                        _vm.$set(_vm.customers, "from", $$v)
                                      },
                                      expression: "customers.from"
                                    }
                                  })
                                ],
                                1
                              ...
                              _c(
                                ...
                                [
                                  ...
                                  _c("b-form-input", {
                                    ...
                                    model: {
                                      value: _vm.customers.to,
                                      callback: function($$v) {
                                        _vm.$set(_vm.customers, "to", $$v)
                                      },
                                      expression: "customers.to"
                                    }
                                  })
                                ],
                                1
