...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    browseOrders: function browseOrders() {
      ...
      this.$store.dispatch('orders/browse', "?paginate=".concat(this.orders.recordsPerPage, "&page=").concat(page, "&filter[search]=").concat(this.orders.search)).then(function (response) {
